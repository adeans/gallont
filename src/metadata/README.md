 ...
 * [gallont.yml](gallont.yml)
     * Determines how your purl.obolibrary.org/obo/gallont/ redirects will be handled
     ...
     * Paste in the contents of [gallont.yml](gallont.yml)
 ...
 * [gallont.md](gallont.md)
     ...
     * Paste in the contents of [gallont.md](gallont.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
